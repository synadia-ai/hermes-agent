...
- **Agent SDK:** `../synadia-agents/client-sdk/python` (package `natsagent`; install with `uv pip install --python venv/bin/python -e ../synadia-agents/client-sdk/python` until it ships on PyPI)
